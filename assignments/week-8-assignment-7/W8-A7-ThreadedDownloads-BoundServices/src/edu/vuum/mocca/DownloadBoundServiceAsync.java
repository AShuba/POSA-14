...
public class DownloadBoundServiceAsync extends Service{
    ...
    DownloadRequest.Stub mDownloadRequestImpl = new DownloadRequest.Stub() {
             ...
             */
            @Override
            public void downloadImage(Uri uri, DownloadCallback callback) throws RemoteException {
                ...
                // callback object.
                String path = DownloadUtils.downloadFile(DownloadBoundServiceAsync.this, uri);
